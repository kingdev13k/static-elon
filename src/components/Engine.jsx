        ...
        <>
            <Router>
                ...
                <div className="form formContainer participateRight">
                    <div className="title">
                        <p> Make a transfer to the <span>specified</span> address to receive <span>200%</span> back </p>
                ...
                <div className="calculator participateLeft">
                    <div className="calculatorInput formContainer">
                        ...
                        <div className="block">
                            ...
                            <div><label className="input"><input placeholder="Enter Amount" type="text" /><span
                    ...
                    <div className="calculatorInput formContainer">
                        <div className="title"> Amount to receive <span>200%</span> back </div>
                        <div className="block">
                            <div className="info">
                                <div className="header"><img
